...
/**
 * Created by ursum on 15/07/2017.
 */

public class QueryUtils {

    static String createStringUrl() {
        String url = "http://content.guardianapis.com/search?order-by=newest&show-references=author&show-tags=contributor&q=Android&api-key=07ed7767-e226-47d4-8f8b-d9f033f45eb1";
        return url;
    }
    ...
    static String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            Log.e("Queryutils error", "Error making HTTP request: ", e);
        } finally {
    ...
    static List<News> parseJson(String response) {
        ...
        try {
            ...
            for (int i = 0; i < resultsArray.length(); i++) {
                ...
                listNews.add(new News(webTitle, author, url, date, section));
            }
        } catch (JSONException e) {
            Log.e("Queryutils class", "Error parsing JSON response", e);
        }
        return listNews;
    }
}
